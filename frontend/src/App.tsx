...
function AppContent() {
  ...
  // ── Main app shell ────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen bg-ambient-mesh flex antialiased selection:bg-blue-600 selection:text-white">
      ...
      <main className="flex-1 flex flex-col min-h-screen min-w-0 overflow-hidden">
        ...
        <header className="md:hidden sticky top-0 z-30 flex items-center justify-between h-14 px-4 bg-white/85 backdrop-blur-md border-b border-slate-200/70 shrink-0">
