...
export const TaskReviewsPage: React.FC<TaskReviewsPageProps> = ({ currentUser }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-[26px] leading-tight font-bold text-slate-900 tracking-tight">Task Reviews</h2>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 sm:gap-3 pl-0 sm:pl-11">
                        ...
                        <div className="flex items-center space-x-2 flex-1 w-full">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-xs font-semibold shadow-sm transition-all disabled:opacity-40 disabled:cursor-not-allowed shrink-0"
                          >
