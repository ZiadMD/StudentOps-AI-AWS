    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-6 border-b border-slate-200/80">
        <div className="space-y-1.5">
          ...
          <h1 className="text-2xl md:text-[26px] leading-tight font-bold text-slate-900 tracking-tight flex flex-wrap items-baseline gap-x-2">
        ...
        <div className="flex items-center space-x-2 shrink-0">
          <button 
            ...
            className="px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-semibold transition-colors shadow-xs flex items-center space-x-2"
          >
