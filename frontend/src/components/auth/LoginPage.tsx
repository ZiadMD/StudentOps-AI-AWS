...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onGoToRegister }) => {
  ...
  return (
    <div className="min-h-screen bg-ambient-mesh flex">
      {/* Left brand column — desktop only */}
      <div className="hidden lg:flex lg:w-[44%] flex-col justify-between bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 p-12 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 py-10 overflow-y-auto">
        ...
        <div className="w-full max-w-md">
          <div className="mb-6">
            <h1 className="text-[28px] font-bold text-slate-900 tracking-tight">Sign in</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-3 bg-white border border-slate-200 rounded-[10px] text-sm text-slate-900 placeholder-slate-400 hover:border-slate-300 focus:outline-none focus:border-blue-500 focus:shadow-focus transition-[border-color,box-shadow] shadow-xs"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3 py-2.5 pr-10 bg-white border border-slate-200 rounded-[10px] text-sm text-slate-900 placeholder-slate-400 hover:border-slate-300 focus:outline-none focus:border-blue-500 focus:shadow-focus transition-[border-color,box-shadow] shadow-xs"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white font-semibold rounded-lg text-sm transition-all shadow-sm flex items-center justify-center space-x-2 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
        ...
        <div className="space-y-3 text-xs text-slate-600">
          ...
          <div className="pt-2 flex justify-end">
            <button
              ...
              className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium"
            >
              Understood
            </button>
          </div>
