...
const badgeVariants = cva(
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-semibold transition-colors gap-1 select-none",
  {
    variants: {
      variant: {
        ...
        purple: "bg-violet-50 text-violet-700 border border-violet-200/70",
