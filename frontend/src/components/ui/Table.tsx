...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-2xl border border-slate-200/80 bg-white shadow-sm">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-slate-50 border-b border-slate-200 text-xs font-semibold text-slate-500", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-4 py-3 text-xs font-semibold text-slate-500 align-middle",
      className
    )}
    {...props}
  />
