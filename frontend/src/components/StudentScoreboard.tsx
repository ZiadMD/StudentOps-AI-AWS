      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-[26px] leading-tight font-bold text-slate-900 tracking-tight">Member Evaluations</h2>
            {isCommitteeHead && (
          ...
          <div>
            ...
            <div className="hidden md:block">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/70 border-b border-slate-200 text-[11px] font-semibold text-slate-500">
              ...
              {filteredData.map((student, idx) => (
                <div key={student.student_id} className="p-4 space-y-3 hover:bg-slate-50/50 transition-colors">
                  ...
                  <div className="grid grid-cols-3 gap-2 p-2.5 bg-slate-50 rounded-lg border border-slate-100 text-center font-mono">
                    <div>
                      <div className="text-[10px] text-slate-400 font-sans font-medium">Behavior</div>
                      <div className="text-xs font-bold text-slate-800 mt-0.5">{student.total_behavior_score}/23</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-slate-400 font-sans font-medium">Task Qual</div>
                      <div className="text-xs font-bold text-slate-800 mt-0.5">{student.average_task_quality.toFixed(1)}/10</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-slate-400 font-sans font-medium">Attendance</div>
            ...
            <div className="pt-3 flex items-center justify-between border-t border-slate-100">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 disabled:opacity-50"
                >
