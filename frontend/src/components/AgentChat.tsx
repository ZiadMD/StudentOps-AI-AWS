...
import { Send, ChevronDown, ChevronRight, Code, Sparkles, Paperclip, CheckCircle2 } from 'lucide-react';
              ...
              {msg.role === 'user' ? (
                ...
                <div className="w-full max-w-3xl flex space-x-4">
                  <div className="w-8 h-8 rounded-full bg-white border border-slate-200 shadow-sm flex items-center justify-center shrink-0 mt-1">
                    <Sparkles className={`w-4 h-4 text-blue-600 ${msg.streaming ? 'animate-pulse' : ''}`} />
                  </div>
