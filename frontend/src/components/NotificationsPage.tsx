  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[26px] leading-tight font-bold text-slate-900 tracking-tight">{t('remindersTitle')}</h2>
          <p className="text-sm text-slate-500 mt-1">{t('remindersSubtitle')}</p>
        </div>
        {!isMember && (
          <button
            onClick={() => setComposing(c => !c)}
            className="inline-flex items-center space-x-2 rtl:space-x-reverse px-4 py-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white rounded-lg text-sm font-semibold shadow-sm transition-all"
          >
      ...
      {!isMember && !composing && (
        <div>
          <h3 className="text-[11px] font-bold text-slate-500 mb-3">Quick Templates</h3>
      ...
      <div>
        <h3 className="text-[11px] font-bold text-slate-500 mb-3">
