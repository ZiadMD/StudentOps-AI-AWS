  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between border-b border-slate-200 pb-4">
        <div>
          <h2 className="text-[26px] leading-tight font-bold text-slate-900 tracking-tight">Schedule & Deadlines</h2>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      {evt.event_type === 'meeting' ? (
                        <span className="px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 text-[9px] font-bold border border-blue-100">Live Session</span>
                      ) : (
                        <span className="px-1.5 py-0.5 rounded bg-amber-50 text-amber-700 text-[9px] font-bold border border-amber-100">Deadline</span>
                      )}
                    </div>
